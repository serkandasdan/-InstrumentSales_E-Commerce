<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="Profil.aspx.cs" Inherits="Enstruman_Satis.Profil" %>
        ...
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td class="auto-style12">
                    <asp:TextBox ID="txtSifre" runat="server" TabIndex="8" Width="130px" Height="24px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="auto-style10">Şifre (Tekrar)</td>
                <td class="auto-style14">
                    <asp:TextBox ID="txtSifreTekrar" runat="server" TabIndex="9" Width="130px" Height="24px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                ...
                &nbsp;<asp:Label ID="lblMesaj" runat="server" Text="Label" Visible="False" ForeColor="Red"></asp:Label>
                 <asp:Button ID="btnGuncelle" runat="server" Height="40px" Align="Center" Text="Bilgileri Güncelle" Width="110px" OnClick="btnGuncelle_Click" TabIndex="10" CssClass="auto-style5" BackColor="#A20319" ForeColor="White"   />
